...
export class MedicoService {
  ...
  getPacientesConSignos(): Observable<any> {
    ...
    return this.http.get(
      `${this.apiUrl}/evoluciones/medico/${medicoId}/pacientes-con-signos`,
    );
  }
  ...
  actualizarEvolucion(
    ...
    return this.http
      .put(`${this.apiUrl}/evoluciones/${evolucionId}`, evolucionData)
      .pipe(
  ...
  crearPrescripcion(
    evolucionId: number,
    prescripcionData: any,
  ): Observable<any> {
    return this.http
      .post(
        `${this.apiUrl}/evolucion/${evolucionId}/prescripciones`,
        prescripcionData,
      )
      .pipe(
  ...
  obtenerPrescripciones(evolucionId: number): Observable<any> {
    return this.http
      .get(`${this.apiUrl}/evolucion/${evolucionId}/prescripciones`)
      .pipe(
  ...
  actualizarPrescripcion(
    ...
    return this.http
      .put(`${this.apiUrl}/prescripciones/${prescripcionId}`, prescripcionData)
      .pipe(
  ...
  eliminarPrescripcion(prescripcionId: number): Observable<any> {
    return this.http
      .delete(`${this.apiUrl}/prescripciones/${prescripcionId}`)
      .pipe(
  ...
  getPacientesClasificados(): Observable<any> {
    const medicoId = this.authService.getUser()?.id;
    return this.http.get(
      `${this.apiUrl}/evoluciones/medico/${medicoId}/pacientes-clasificados`,
    );
  }

  getPacientesOtrosMedicos(): Observable<any> {
    return this.http
      .get(`${this.apiUrl}/evoluciones/otros-medicos/pacientes`)
      .pipe(
  ...
  getEvolucionesOtroMedico(pacienteId: number): Observable<any> {
    return this.http
      .get(
        `${this.apiUrl}/evoluciones/paciente/${pacienteId}/evoluciones-otros`,
      )
      .pipe(
  ...
  getEvolucionesPaciente(pacienteId: number): Observable<any> {
    ...
    return this.http
      .get<any>(
        `${this.apiUrl}/evoluciones/paciente/${pacienteId}/todas-evoluciones`,
      )
      .pipe(
        tap((response) => {
